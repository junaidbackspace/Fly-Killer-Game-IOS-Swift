...
//  FlyKillerGame
//
//  Created by Naeem Abbas on 26/05/2024.
//
...
//    var lifeCount = 3
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        imageView.image = UIImage(named: "honeybee1")
        imageview2.image = UIImage(named: "new_fly1")
...
//            imagekillview1.isHidden = true
    ...
    func translateImageViews01(imageViews: [UIImageView]) {

// Calculate the final position for the image views (at the bottom of the screen)
        let finalY = view.frame.size.height //imageViews[0].frame.size.height

        // Create UIViewPropertyAnimator for translation animation
...
// Restart the animation for all image views
            self.translateImageViews01(imageViews: imageViews)
        })
...
@objc func imageViewTapped(_ gesture: UITapGestureRecognizer) {
    ...
    var imageIndex2 = 0
    var imageIndex3 = 0
    let images1 = ["fly1", "fly2", "fly3", "fly4", "fly5"]
    let images2 = ["new_fly1", "new_fly2"]
    let images3 = ["honeybee1", "honeybee2"]
    // Names of your images

    @objc func changeImage() {
            // Set image
        imageView.image = UIImage(named: images1[imageIndex1])
        imageview2.image = UIImage(named: images2[imageIndex2])
        imageview3.image = UIImage(named: images3[imageIndex3])

            // Update index for next image
            imageIndex1 = (imageIndex1 + 1) % images1.count
        ...
        // Check if score reaches 20
           if score >= 40 {
               ...
               let alertController = UIAlertController(title: "Level two Complete", message: "Congratulations! You've completed level two.\nTotal Score: \(totalScore)", preferredStyle: .alert)
...
//    @IBAction func allimagekill(_ sender: UIButton) {
//        // Iterate through all UIImageViews containing the fly images and hide them
//        imageView.isHidden = true
//            imageview2.isHidden = true
//            imageview3.isHidden = true
